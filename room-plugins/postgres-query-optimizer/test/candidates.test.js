...
describe('determinePlanShapeChanged', () => {
...
describe('recomputeFrontier', () => {
  ...
  it('excludes candidates with high risk score', () => {
    const state = {
      candidates: [
        {
          candidateId: 'c1',
...
describe('chooseStopReason', () => {
  ...
  it('returns target_met when plateau + target exceeded + approved', () => {
    const state = {
      candidates: [
        { candidateId: 'c1', result: { medianMs: 10, cvPct: 5 }, status: 'frontier', speedupPct: 50, approved: true },
      ],
      cycleIndex: 2,
      plateauCount: 2,
      bestImprovementPct: 50,
  ...
  it('returns plateau as catch-all', () => {
    const state = {
      candidates: [
        { candidateId: 'c1', result: { medianMs: 10, cvPct: 5 }, status: 'frontier', speedupPct: 10, approved: true },
      ],
      cycleIndex: 2,
      plateauCount: 2,
      bestImprovementPct: 10,
      frontierIds: ['c1'],
    };
